...
```bash
npm test -- https://example.com/tour/things-to-consider-on-singles-tours.html
```
...
```bash
npm run test:url https://example.com/tour/things-to-consider-on-singles-tours.html
```
...
node codegen.js https://example.com/tour/things-to-consider-on-singles-tours.html 1920 1080

# Or directly with Playwright
npx playwright codegen --viewport-size="1920,1080" https://example.com/tour/things-to-consider-on-singles-tours.html
```
