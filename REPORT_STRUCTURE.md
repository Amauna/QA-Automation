...
- **Root URLs**: `test-results/<domain>/`
  - Example: `https://example.com/` → `test-results/example.com/`

- **URLs with paths**: `test-results/<domain>/<path>/`
  - Example: `https://example.com/tour/page.html` → `test-results/example.com/tour/`
...
- **Root URLs**: `playwright-report/<domain>/`
  - Example: `https://example.com/` → `playwright-report/example.com/`

- **URLs with paths**: `playwright-report/<domain>/<path>/`
  - Example: `https://example.com/tour/page.html` → `playwright-report/example.com/tour/`
...
2. **Path extraction**: Splits URL path into directory segments
   - `https://example.com/tour/things.html` → `example.com/tour/`
...
```
URL: https://example.com/tour/things-to-consider.html
