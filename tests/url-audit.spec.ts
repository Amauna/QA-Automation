 ...
 * 
 * Note: The default URL uses a neutral example domain. Override via env vars in real projects.
 */
const TEST_URL = process.env.URL_AUDIT_URL || process.env.TEST_URL || process.env.BASE_URL || 'https://example.com/';
