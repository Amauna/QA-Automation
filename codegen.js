...
if (args.length === 0) {
  ...
  console.error('  node codegen.js https://example.com/page.html 1920 1080');
  console.error('  node codegen.js https://example.com/page.html --viewport-size="1920,1080"');
  console.error('  node codegen.js https://example.com/page.html (defaults to 1280x720)');
  console.error('');
