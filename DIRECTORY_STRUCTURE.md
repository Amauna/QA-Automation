...
| `https://example.com/tour/page.html` | `example.com/tour/` | `example.com/tour/` |
| `https://www.sample-domain.com/` | `sample-domain.com/` | `sample-domain.com/` |
| `https://sample-domain.com/about/team.html` | `sample-domain.com/about/` | `sample-domain.com/about/` |
...
# Test URL 2  
npm run test:url -- https://example.com/tour/

# Test URL 3
npm run test:url -- https://another-example.com/
```

Result:
```
test-results/
├── example.com/          # From URL 1
├── example.com/tour/     # From URL 2
└── another-example.com/  # From URL 3
